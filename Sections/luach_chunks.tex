...
\newcommand{\shabbatVaEra}[1]{\textbf{Shabbat VaEra \textemdash\space #1 Shevat}
...
\newcommand{\shabbatBo}[1]{\textbf{Shabbat Bo \textemdash\space #1 Shevat}
...
\newcommand{\shirasHaYamInstructions}{\textit{Instructions for leining shirat hayam here}}

\newcommand{\tenCommandmentsInstructions}{\textit{Instructions for reading the ten commandments here}}

\newcommand{\shabbatShira}[1]{\textbf{Shabbat Shira (Parashat Beshala\d{h}) \textemdash\space #1 Shevat}
	
	\normalshabbosarvit \normalshabbatshacharit
	
	\leinBeshalach
	
	\shirasHaYamInstructions
...
\newcommand{\shabbatYitro}[1]{\textbf{Shabbat Yitro \textemdash\space #1 Shevat}
	
	\normalshabbosarvit \normalshabbatshacharit
	
	\leinYitro
	
	\tenCommandmentsInstructions
...
\newcommand{\tubishvat}{\textbf{15th of Shevat}

The 15th of Shevat is the beginning of the year for reckoning the ages of trees, for purpose of agricultural laws. Most omit Ta\d{h}anun on this day, along with the \textit{yehi ratzon} paragraphs as the Torah is wrapped. Lamenatzea\d{h} is recited.
}

\newcommand{\shevatThurs}{
\roshchodeshday{Thursday}
